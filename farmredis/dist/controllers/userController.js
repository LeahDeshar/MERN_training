...
export const registerController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const findEmail = yield Users.findOne({ email: email });
        if (findEmail) {
            return res.status(400).json({
...
export const loginController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let user = yield Users.findOne({ email });
        if (!user) {
            return res.status(400).json({
...
export const getUserProfileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield Users.findById(req.user._id).select("-password");
...
export const profileUpdateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield Users.findById(req.user._id);
...
export const passUpdateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield Users.findById(req.user._id);
...
export const profilePicUpdateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield Users.findById(req.user._id);
        const file = getDataUri(req.file);
        console.log(req.file);
        if (user.profilePic && user.profilePic.public_id) {
            yield cloudinary.v2.uploader.destroy(user.profilePic.public_id);
        }
...
export const resetPasswordController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield Users.findOne({ email, answer });
        if (!user) {
            return res.status(400).json({
                msg: "Email does not exist",
                success: false,
